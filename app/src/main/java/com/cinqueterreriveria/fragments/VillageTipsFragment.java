...
public class VillageTipsFragment extends Fragment {
    ...
    ShimmerFrameLayout shimmer_blog_village_tips;
    LinearLayout ll_blogvillage_tips;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ll_blogvillage_tips=view.findViewById(R.id.ll_blogvillage_tips);
        shimmer_blog_village_tips=view.findViewById(R.id.shimmer_blog_village_tips);
    ...
    private void BlogCategoryAPI()
    {
        Call<BlogCategoryModel> call= Rest.getRetrofit().blogCategory(ApiConstents.SECRET_KEY,
                "cinque-terre-villages-tips");
        shimmer_blog_village_tips.startShimmerAnimation();
        call.enqueue(new Callback<BlogCategoryModel>() {
            ...
            public void onResponse(Call<BlogCategoryModel> call, Response<BlogCategoryModel> response) {
                shimmer_blog_village_tips.stopShimmerAnimation();
                shimmer_blog_village_tips.setVisibility(View.GONE);
                if (response.isSuccessful())
                {
                    if (response.body().getSuccess() == true)
                    {
                        ll_blogvillage_tips.setVisibility(View.VISIBLE);
                        ...
                        rv_blogs_village_tips.setAdapter(new BlogAccommodationAdapter(getActivity(),response.body().getDetail().getBlogDescription()));
