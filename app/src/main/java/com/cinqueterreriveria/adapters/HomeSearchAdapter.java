...
public class HomeSearchAdapter extends RecyclerView.Adapter<HomeSearchAdapter.MyViewHolder> {

    Context context;
    List<HomeSearchModel.LocationProperty> locationProperties;
    String place_name;

    public HomeSearchAdapter(Context context, List<HomeSearchModel.LocationProperty> locationProperties) {
    ...
    @Override
    public HomeSearchAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_places_list, parent, false);

        return new HomeSearchAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final HomeSearchAdapter.MyViewHolder holder, final int position) {
