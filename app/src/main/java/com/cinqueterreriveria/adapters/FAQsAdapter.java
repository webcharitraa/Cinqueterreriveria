...
public class FAQsAdapter extends RecyclerView.Adapter<FAQsAdapter.MyViewHolder> {
    ...
    List<FAQsModel.Detail> detail;
    View v;

    public FAQsAdapter(Context context, List<FAQsModel.Detail> detail) {
        this.context = context;
        this.detail = detail;
    }

    @Override
    public FAQsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_faqs, parent, false);

        return new FAQsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final FAQsAdapter.MyViewHolder holder, final int position) {
